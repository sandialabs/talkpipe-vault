...
def _get_talkpipe_config_value(key: str, default: str, alternative_keys: list[str] | None = None) -> str:
    """
...
def get_chat_model() -> str:
    ...
    return _get_talkpipe_config_value(
        'chat_model', 
        CHAT_MODEL,
        alternative_keys=['default_model_name', 'CHAT_MODEL']
    )
...
def get_document_template() -> str:
    ...
    return _get_talkpipe_config_value(
        'document_template',
        DOCUMENT_TEMPLATE,
        alternative_keys=['DOCUMENT_TEMPLATE']
    )
...
def get_shingle_template() -> str:
    ...
    return _get_talkpipe_config_value(
        'shingle_template',
        SHINGLE_TEMPLATE,
        alternative_keys=['SHINGLE_TEMPLATE']
    )
